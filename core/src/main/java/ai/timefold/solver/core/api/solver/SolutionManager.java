...
public interface SolutionManager<Solution_, Score_ extends Score<Score_>> {
     ...
     * @see SolutionUpdatePolicy Description of individual policies with respect to performance trade-offs.
     */
    @NonNull ScoreAnalysis<Score_> analyze(@NonNull Solution_ solution, @NonNull ScoreAnalysisFetchPolicy fetchPolicy,
     ...
     */
    default <EntityOrElement_, Proposition_> @NonNull List<RecommendedFit<Proposition_, Score_>> recommendFit(@NonNull Solution_ solution,
            @NonNull EntityOrElement_ fittedEntityOrElement, @NonNull Function<EntityOrElement_, Proposition_> propositionFunction) {
     ...
     */
    <EntityOrElement_, Proposition_> @NonNull List<RecommendedFit<Proposition_, Score_>> recommendFit(@NonNull Solution_ solution,
            @NonNull EntityOrElement_ fittedEntityOrElement, @NonNull Function<EntityOrElement_, Proposition_> propositionFunction,
